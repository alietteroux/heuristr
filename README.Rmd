...
You can install the development version of rheurist from [GitHub](https://github.com/) with:
...
As an example, from [this Heurist database (named "aliet_test_R")](https://heurist.huma-num.fr/heurist/?db=aliet_test_R&website), we've exported two XML files : have a look to the folder "documents/data_example" of this repository.
...
For more details, see [https://alietteroux.github.io/heuristr/](https://alietteroux.github.io/heuristr/)
